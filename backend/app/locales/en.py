EN = {
    ...
    "dashboard.rollups_historical": "Historical rollup events",
    "dashboard.rollup_day": "Rollup day",
    "dashboard.rollup_event_types": "Rollups by event type",
    "dashboard.rollup_help": "Precomputed completed-day rollups used for fast dashboard summaries and historical aggregation.",
    "dashboard.rollup_scenarios": "Rollups by scenario",
    "dashboard.rollup_scenarios_help": "Correlated scenario counters from event payloads, for example CrowdSec scenarios.",
