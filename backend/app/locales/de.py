DE = {
    ...
    "dashboard.rollups_historical": "Historische Rollup-Events",
    "dashboard.rollup_day": "Rollup-Tag",
    "dashboard.rollup_event_types": "Rollups nach Event-Typ",
    "dashboard.rollup_help": "Vorberechnete Rollups abgeschlossener Tage für schnelle Dashboard-Zusammenfassungen und historische Aggregation.",
    "dashboard.rollup_scenarios": "Rollups nach Szenario",
    "dashboard.rollup_scenarios_help": "Korrelierte Szenario-Zähler aus Event-Daten, z.B. CrowdSec-Szenarien.",
