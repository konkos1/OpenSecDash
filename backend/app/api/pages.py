...
def settings_page(request: Request, db: Session = Depends(get_db)):
    ...
    return render(
        ...
        notifications_smtp_ca_file=get_setting_value(db, "notifications.smtp_ca_file", ""),
...
def save_notification_settings(
    ...
    notifications_smtp_ca_file: str = Form(""),
    ...
    for key, value in {
        ...
        "notifications.smtp_ca_file": notifications_smtp_ca_file,
