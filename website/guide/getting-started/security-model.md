...
It can therefore block **no earlier than the second access**. This is not a guarantee;
provider, enrichment, LAPI, or bouncer latency and errors can allow further accesses.
:::
