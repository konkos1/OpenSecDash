...
export default defineConfig({
  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Code style', link: '/guide/contributing/code-style' },
    ...
    footer: {
      message: 'Released under the GNU Affero General Public License v3.0. <a href="/third-party-notices.txt">Third-party licenses</a>.',
