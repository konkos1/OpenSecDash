...
class Plugin(PeriodicPlugin):
    ...
    settings = [
        ...
        PluginSetting(
            "apps_master",
            "apps_inventory.settings.apps_master",
            "apps_inventory.settings.apps_master.help",
            "select",
            "opensecdash",
            [("opensecdash", "apps_inventory.option.master_opensecdash"), ("external", "apps_inventory.option.master_external")],
            visible_if=("enabled", "true"),
        ),
        PluginSetting(
            "inventory_interval",
    ...
    locales = {
        "en": {
            ...
            "apps_inventory.settings.apps_master": "Master for app values",
            "apps_inventory.settings.apps_master.help": "Controls whether version and release URL are maintained in OpenSecDash or overwritten from apps-installed.json for existing apps.",
            "apps_inventory.option.master_opensecdash": "OpenSecDash",
            "apps_inventory.option.master_external": "External import",
        ...
        "de": {
            ...
            "apps_inventory.settings.apps_master": "Master für App-Werte",
            "apps_inventory.settings.apps_master.help": "Legt fest, ob Version und Release-URL in OpenSecDash gepflegt oder bei bestehenden Apps aus apps-installed.json überschrieben werden.",
            "apps_inventory.option.master_opensecdash": "OpenSecDash",
            "apps_inventory.option.master_external": "Externer Import",
